...
export const PLANS: Record<string, Plan> = {
  starter: {
    ...
    offerId: "32rof96",
    annualOfferId: "starter_anual",
    checkoutUrl: "https://pay.cakto.com.br/32rof96",
    annualCheckoutUrl: "https://pay.cakto.com.br/starter_anual",
    features: [
      "Até 15 alunos",
      "Agenda completa",
      "Montagem de treinos",
  ...
  pro: {
    ...
    offerId: "onb2wr2",
    annualOfferId: "pro_anual",
    checkoutUrl: "https://pay.cakto.com.br/onb2wr2",
    annualCheckoutUrl: "https://pay.cakto.com.br/pro_anual",
    features: [
      "Até 25 alunos",
      "Tudo do Starter +",
  ...
  business: {
    ...
    offerId: "zh3rnh6",
    annualOfferId: "business_anual",
    checkoutUrl: "https://pay.cakto.com.br/zh3rnh6",
    annualCheckoutUrl: "https://pay.cakto.com.br/business_anual",
    features: [
      "Até 40 alunos",
      "Tudo do Pro +",
      "Múltiplos personais",
  ...
  premium: {
    ...
    offerId: "kbevbfw",
    annualOfferId: "premium_anual",
    checkoutUrl: "https://pay.cakto.com.br/kbevbfw",
    annualCheckoutUrl: "https://pay.cakto.com.br/premium_anual",
    features: [
      "Até 70 alunos",
      "Tudo do Business +",
  ...
  enterprise: {
    ...
    offerId: "apzipd3",
    annualOfferId: "enterprise_anual",
    checkoutUrl: "https://pay.cakto.com.br/apzipd3",
    annualCheckoutUrl: "https://pay.cakto.com.br/enterprise_anual",
    features: [
      "Até 150 alunos",
      "Tudo do Premium +",
      "Suporte dedicado",
