...
async function main() {
  try {
    ...
    console.log("DELETANDO OFERTAS ANTIGAS");
    console.log("=" .repeat(60));

    for (const offerId of OLD_OFFER_IDS) {
      await deleteOffer(token, offerId);
    }

    console.log("\n" + "=" .repeat(60));
    console.log("CRIANDO OFERTAS NOVAS COM PREÇOS CORRETOS");
    console.log("=" .repeat(60));
